...
class GeneralGameTest {
    ...
    void testGameEndsWithDraw() {
        ...
        assertEquals(Board.GameState.DRAW, game.getCurrentGameStatus()); // Game should end in tie
    }

    @Test
    void testBlueWinsBySOSFormation() {
        simulateBlueWinningSOS();
        assertEquals(Board.GameState.BLUE_WINS, game.getCurrentGameStatus());
    }
    ...
    private void simulateBlueWinningSOS() {
        ...
        game.makeMove(2, 2, Board.Cell.S); // B SOS 
